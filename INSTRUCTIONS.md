...
## hCaptcha (demo protection)
- Set `NEXT_PUBLIC_HCAPTCHA_SITE_KEY` in `.env.local`.
- Enable CAPTCHA protection in Supabase Dashboard: Auth > Settings > Bot and Abuse Protection.
